...
Oracle: `fieldrun`. **empirical** corpus measurements.
...
| raw_copy | 22/24 | 100.0% | 91.7% | 2/24 | 0/4 | not certified |
| selected | 0/24 | 0.0% | undefined | 0/24 | 0/4 | not certified |

Baseline: 24 suffix facts. Runtime sizes (including Datalog scaffolding): baseline=3179 bytes, raw_copy=972 bytes, selected=3179 bytes
