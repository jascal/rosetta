# stories110M · historical temperature measurements (`empirical`)
...
- rules: 280 (n-gram, top-K mean 21.7)

| T | contexts | max TV | verdict |
|---|---|---|---|
| 0.7 | 300/300 | 0.0047 | historical Python check passed |
| 0.85 | 300/300 | 0.0073 | historical Python check passed |
| 1.0 | 300/300 | 0.0118 | historical Python check passed |
