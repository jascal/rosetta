# qwen25coder15b · historical unified-cover measurements (`empirical`)
...
- rules: 296 (no idioms + 296 n-gram, top-K mean 19.9)

| T | contexts | max TV | verdict |
|---|---|---|---|
| 0.7 | 300/300 | 0.0046 | historical Python check passed |
| 0.85 | 300/300 | 0.0061 | historical Python check passed |
...
**761/761 match the model at argmax** (`empirical`; historical comparison, no retained Datalog certificate).
