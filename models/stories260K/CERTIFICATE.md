# stories260K · certificate (T-parameterized — the canonical artifact)

`circuits.dl` carries top-K logits (incidence) per rule; the runtime computes `softmax(logits/T)` in souffle
at a queried `.input temp` (T=0 = the argmax collapse). Build-time logits from whole.dl.
...
|---|---|---|---|
| 0.7 | 300/300 | 0.0022 | CERTIFIED |
| 0.85 | 300/300 | 0.0053 | CERTIFIED |
| 1.0 | 300/300 | 0.0119 | CERTIFIED |
