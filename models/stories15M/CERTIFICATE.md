# stories15M · historical temperature measurements (`empirical`)
...
|---|---|---|---|
| 0.7 | 300/300 | 0.0032 | historical Python check passed |
| 0.85 | 300/300 | 0.0062 | historical Python check passed |
